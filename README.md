...
<head>
    ...
    <title>Brilliant Sukma Mahardika | Portfolio</title>
    <meta name="description" content="Portfolio Brilliant Sukma Mahardika - Programmer, Designer & Tech Enthusiast">
        ...
        <div class="row g-4">
            ...
            <div class="col-sm-6 col-lg-3 reveal">
                <div class="glass-card h-100 p-4">
                    ...
                    <p class="text-muted-custom small mb-0">Modern PHP framework untuk aplikasi web.</p>
                </div>
            </div>
